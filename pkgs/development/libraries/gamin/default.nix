...
in stdenv.mkDerivation (rec {
  ...
  patches = [ ./deadlock.patch ]
    ...
    }) ++ stdenv.lib.optional (cross && stdenv.hostPlatform.isLinux) ./abstract-socket-namespace-linux.patch
       ++ stdenv.lib.optional (cross && stdenv.hostPlatform.isDarwin) ./abstract-socket-namespace-darwin.patch ;
